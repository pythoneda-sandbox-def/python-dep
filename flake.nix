...
#
# Copyright (C) 2023-today rydnr's https://github.com/pythoneda-sandbox-def/python-dep
#
  ...
  outputs = inputs:
    ...
    in flake-utils.lib.eachSystem supportedSystems (system:
      ...
      in rec {
        ...
        devShells = rec {
          default = pythoneda-sandbox-python-dep-python312;
          ...
          pythoneda-sandbox-python-dep-python312 = shared.devShell-for {
            banner = "${
                pythoneda-shared-pythonlang-banner.packages.${system}.pythoneda-shared-pythonlang-banner-python312
              }/bin/banner.sh";
            extra-namespaces = "";
            nixpkgs-release = nixpkgsRelease;
            package = packages.pythoneda-sandbox-python-dep-python312;
          ...
          pythoneda-sandbox-python-dep-python313 = shared.devShell-for {
            banner = "${
                pythoneda-shared-pythonlang-banner.packages.${system}.pythoneda-shared-pythonlang-banner-python313
              }/bin/banner.sh";
            extra-namespaces = "";
            nixpkgs-release = nixpkgsRelease;
            package = packages.pythoneda-sandbox-python-dep-python313;
        ...
        packages = rec {
          ...
          pythoneda-sandbox-python-dep-python312 =
            pythoneda-sandbox-python-dep-for {
              python = pkgs.python312;
              pythoneda-shared-pythonlang-domain =
                pythoneda-shared-pythonlang-domain.packages.${system}.pythoneda-shared-pythonlang-domain-python312;
            };
          pythoneda-sandbox-python-dep-python313 =
            pythoneda-sandbox-python-dep-for {
              python = pkgs.python313;
              pythoneda-shared-pythonlang-domain =
                pythoneda-shared-pythonlang-domain.packages.${system}.pythoneda-shared-pythonlang-domain-python313;
